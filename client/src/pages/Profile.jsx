...
export default function Profile() {
  //get user info from redux store that come from the signin action 
    ...
    const getUserDetailsQuery = useGetUserDetailsQuery('userDetails');
    ...
    console.log("User query: ", getUserDetailsQuery)
    // console.log("User query first name", getUserDetailsQuery.data.body.firstName)
  if (!userInfo) {
